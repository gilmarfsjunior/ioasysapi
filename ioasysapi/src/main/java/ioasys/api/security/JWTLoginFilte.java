...
public class JWTLoginFilte extends AbstractAuthenticationProcessingFilter {
	
	//Configura o gerenciador de autenticação
	protected JWTLoginFilte(String url, AuthenticationManager authenticationManager) {
